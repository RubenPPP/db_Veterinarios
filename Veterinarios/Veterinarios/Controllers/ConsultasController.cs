...
namespace Veterinarios.Controllers
{
    ...
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,Observacoes,AuxValorConsulta,ValorConsultaAnimalFK,VeterinarioFK")] Consultas consulta)
        {
            // Recuperar o valor auxiliar do preço da consulta 
            // Atribuir ao atributo que guarda esse dado
